jQuery(document).ready(function(){
    //include Custom.JS
    jQuery('head').append('<link rel="stylesheet" type="text/css" media="all" href="'+BASE_URL+'custom_tools/css/colorpicker.css">');
    jQuery('head').append('<script type="text/javascript" src="'+BASE_URL+'custom_tools/js/jquery.cookie.js"></script>');
    /*jQuery('head').append('<script type="text/javascript" src="'+BASE_URL+'custom_tools/js/colorpicker.js"></script>');*/
    /*jQuery('head').append('<script type="text/javascript" src="'+BASE_URL+'custom_tools/js/custom-block.js"></script>');*/
});
...
*/
	...
	jQuery.each(arrPuzzleColor, function(){
		...
		if(jQuery(this).attr('data-puzzlecolor'))
		{
			var puzzleColor = jQuery(this).attr('data-puzzlecolor');
		}
		else
		{
			var puzzleColor = '000000';
		}
		...
		jQuery(this).css("background-color", 'rgba('+clr.r+','+clr.g+','+clr.b+',0.9)');
		//jQuery(this).find('.reviews_summary').css("background-color", '#'+puzzleColor);
		//jQuery(this).find('.reviews_summary').css("background-color", 'rgba('+clr.r+','+clr.g+','+clr.b+',0.3)');
