...
###############################################################################################################
	...
	*/
		public function  __construct($apikey = 'c1f8be0bff5fc11dfd68ddf4c39b7d98',$lang='es') {
			//Assign Api Key
	...
	* @param integer $page
	*/
	public function nowPlayingMovies($page=1,$lang='es') {
		return $this->_call('movie/now-playing', 'page='.$page,$lang);
	}

	/**
	* Autor: GORKA G.
	* Similar Movies 
	* http://api.themoviedb.org/3/movie/{id}/similar?api_key&language&page
	* @param integer $page
	*/
	public function similarMovies($idMovie,$page=1) {
		return $this->_call('movie/'.$idMovie.'/similar', 'page='.$page);
	}
	...
	* @param integer $page
	*/
	public function topRated($page=1,$lang='es') {
		return $this->_call('movie/top_rated', 'page='.$page,$lang);
	}
	...
	* @param integer $page
	*/
	public function popularMovies($page=1,$lang='es') {
		return $this->_call('movie/popular', 'page='.$page,$lang);
	}
	...
	* @return array
	*/
	public function getGenres($lang = 'es') {
		return $this->_call('genre/movie/list','',$lang);
	}
	...
	* @return array
	*/
	public function discoverMovies($page=1,$params='',$lang = 'es') {
		return $this->_call('discover/movie','page='.$page.'&'.$params,$lang);
	}
